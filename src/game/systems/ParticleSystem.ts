...
const PARTICLE_PRESETS: Record<string, ParticleConfig> = {
  ...
  trail_laser: {
    count: 2,
    colors: [0xff00ff, 0xff88ff, 0xffffff],
    speedMin: 0,
    speedMax: 15,
    sizeMin: 3,
    sizeMax: 6,
